...
abstract class Food extends Item {
	...
	public abstract function getFoodRestoration() : int;

	public abstract function getSaturationRestoration() : float;
	...
	public function onConsume(Entity $human) {
		...
		$human->addSaturation($ev->getSaturationRestoration());
		$human->addFood($ev->getFoodRestoration());
