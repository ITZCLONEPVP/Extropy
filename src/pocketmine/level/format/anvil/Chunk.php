...
class Chunk extends BaseChunk {
	...
	public function toBinary() {
		...
		foreach($this->getSections() as $section) {
			...
			$nbt->Sections[$section->getY()] = new Compound(null, ["Y" => new ByteTag("Y", $section->getY()), "Blocks" => new ByteArray("Blocks", $section->getIdArray()), "Data" => new ByteArray("Data", $section->getDataArray()), "BlockLight" => new ByteArray("BlockLight", $section->getLightArray()), "SkyLight" => new ByteArray("SkyLight", $section->getSkyLightArray())]);
		}
