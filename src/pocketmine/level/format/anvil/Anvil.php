...
class Anvil extends McRegion {
	...
	public static function createChunkSection($Y) {
		return new ChunkSection(new CompoundTag(null, ["Y" => new ByteTag("Y", $Y), "Blocks" => new ByteArrayTag("Blocks", str_repeat("\x00", 4096)), "Data" => new ByteArrayTag("Data", str_repeat("\x00", 2048)), "SkyLight" => new ByteArrayTag("SkyLight", str_repeat("\xff", 2048)), "BlockLight" => new ByteArrayTag("BlockLight", str_repeat("\x00", 2048))]));
	}
