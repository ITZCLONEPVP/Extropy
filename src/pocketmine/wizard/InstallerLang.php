...
class InstallerLang {
	...
	public static $languages = ["en" => "English", "es" => "Español", "zh" => "中文", "ru" => "Pyccĸий", "ja" => "日本語", "de" => "Deutsch", //"vi" => "Tiếng Việt",
		"ko" => "한국어", "nl" => "Nederlands", "fr" => "Français", "it" => "Italiano", //"lv" => "Latviešu",
		"ms" => "Melayu", "no" => "Norsk", //"pt" => "Português",
		"sv" => "Svenska", "fi" => "Suomi", "tr" => "Türkçe",//"et" => "Eesti",
	];
