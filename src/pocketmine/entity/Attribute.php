...
class Attribute {
	...
	public static function init() {
		...
		self::addAttribute(self::KNOCKBACK_RESISTANCE, "minecraft:knockbackResistance", 0.00, 1.00, 0.00);
		...
		self::addAttribute(self::FOLLOW_RANGE, "minecraft:followRange", 0.00, 2048.00, 16.00, false);
		self::addAttribute(self::HUNGER, "minecraft:player.hunger", 0.00, 20.00, 20.00);
		self::addAttribute(self::ATTACK_DAMAGE, "minecraft:attackDamage", 0.00, 340282346638528859811704183484516925440.00, 1.00, false);
		self::addAttribute(self::EXPERIENCE_LEVEL, "minecraft:player.level", 0.00, 2147483647.00, 0.00);
