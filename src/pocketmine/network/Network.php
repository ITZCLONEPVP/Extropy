...
class Network {
	...
	private function registerPackets() {
		...
		$this->registerPacket(ProtocolInfo::ADD_ITEM_PACKET, AddItemEntityPacket::class);
	...
	public function processBatch(BatchPacket $packet, Player $p) {
		try {
			if(strlen($packet->payload) <= 0) {
				throw new \InvalidArgumentException("BatchPacket payload is empty or the server encountered a packet decoding error");
			}
