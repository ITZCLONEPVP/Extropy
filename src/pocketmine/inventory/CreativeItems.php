...
class CreativeItems {
	...
	const ITEMS = [self::CATEGORY_BUILDING => [["id" => Item::COBBLESTONE], ["id" => Item::STONE_BRICKS], ["id" => Item::STONE_BRICKS, "meta" => StoneBricks::MOSSY], ["id" => Item::STONE_BRICKS, "meta" => StoneBricks::CRACKED], ["id" => Item::STONE_BRICKS, "meta" => StoneBricks::CHISELED], ["id" => Item::MOSS_STONE], ["id" => Item::PLANKS, "meta" => Planks::OAK], ["id" => Item::PLANKS, "meta" => Planks::SPRUCE], ["id" => Item::PLANKS, "meta" => Planks::BIRCH], ["id" => Item::PLANKS, "meta" => Planks::JUNGLE], ["id" => Item::PLANKS, "meta" => Planks::ACACIA], ["id" => Item::PLANKS, "meta" => Planks::DARK_OAK], ["id" => Item::BRICKS], ["id" => Item::STONE], ["id" => Item::STONE, "meta" => Stone::GRANITE], ["id" => Item::STONE, "meta" => Stone::POLISHED_GRANITE], ["id" => Item::STONE, "meta" => Stone::DIORITE], ["id" => Item::STONE, "meta" => Stone::POLISHED_DIORITE], ["id" => Item::STONE, "meta" => Stone::ANDESITE], ["id" => Item::STONE, "meta" => Stone::POLISHED_ANDESITE], ["id" => Item::DIRT], ["id" => Item::PODZOL], ["id" => Item::GRASS], ["id" => Item::MYCELIUM], ["id" => Item::CLAY_BLOCK], ["id" => Item::HARDENED_CLAY], ["id" => Item::STAINED_CLAY, "meta" => 0], //TODO: Make a class containing colour constants
		["id" => Item::STAINED_CLAY, "meta" => 1], ["id" => Item::STAINED_CLAY, "meta" => 2], ["id" => Item::STAINED_CLAY, "meta" => 3], ["id" => Item::STAINED_CLAY, "meta" => 4], ["id" => Item::STAINED_CLAY, "meta" => 5], ["id" => Item::STAINED_CLAY, "meta" => 6], ["id" => Item::STAINED_CLAY, "meta" => 7], ["id" => Item::STAINED_CLAY, "meta" => 8], ["id" => Item::STAINED_CLAY, "meta" => 9], ["id" => Item::STAINED_CLAY, "meta" => 10], ["id" => Item::STAINED_CLAY, "meta" => 11], ["id" => Item::STAINED_CLAY, "meta" => 12], ["id" => Item::STAINED_CLAY, "meta" => 13], ["id" => Item::STAINED_CLAY, "meta" => 14], ["id" => Item::STAINED_CLAY, "meta" => 15], ["id" => Item::SANDSTONE], ["id" => Item::SANDSTONE, "meta" => Sandstone::CHISELED], //Creeper sandstone
		["id" => Item::SANDSTONE, "meta" => Sandstone::SMOOTH], ["id" => Item::RED_SANDSTONE], ["id" => Item::RED_SANDSTONE, "meta" => Sandstone::CHISELED], //Wither sandstone
		["id" => Item::RED_SANDSTONE, "meta" => Sandstone::SMOOTH], ["id" => Item::SAND], ["id" => Item::SAND, "meta" => Sand::RED], ["id" => Item::GRAVEL], ["id" => Item::WOOD, "meta" => Wood::OAK], ["id" => Item::WOOD, "meta" => Wood::SPRUCE], ["id" => Item::WOOD, "meta" => Wood::BIRCH], ["id" => Item::WOOD, "meta" => Wood::JUNGLE], ["id" => Item::WOOD2, "meta" => Wood2::ACACIA], #blamemojang
		["id" => Item::WOOD2, "meta" => Wood2::DARK_OAK], ["id" => Item::NETHER_BRICK_BLOCK], ["id" => Item::NETHERRACK], ["id" => Item::SOUL_SAND], ["id" => Item::BEDROCK], ["id" => Item::COBBLE_STAIRS], ["id" => Item::OAK_WOOD_STAIRS], ["id" => Item::SPRUCE_WOOD_STAIRS], ["id" => Item::BIRCH_WOOD_STAIRS], ["id" => Item::JUNGLE_WOOD_STAIRS], ["id" => Item::ACACIA_WOOD_STAIRS], ["id" => Item::DARK_OAK_WOOD_STAIRS], ["id" => Item::BRICK_STAIRS], ["id" => Item::SANDSTONE_STAIRS], ["id" => Item::RED_SANDSTONE_STAIRS], ["id" => Item::STONE_BRICK_STAIRS], ["id" => Item::NETHER_BRICK_STAIRS], ["id" => Item::QUARTZ_STAIRS], ["id" => Item::STONE_SLAB], ["id" => Item::STONE_SLAB, "meta" => StoneSlab::COBBLESTONE], ["id" => Item::WOODEN_SLAB, "meta" => Planks::OAK], ["id" => Item::WOODEN_SLAB, "meta" => Planks::SPRUCE], ["id" => Item::WOODEN_SLAB, "meta" => Planks::BIRCH], ["id" => Item::WOODEN_SLAB, "meta" => Planks::JUNGLE], ["id" => Item::WOODEN_SLAB, "meta" => Planks::ACACIA], ["id" => Item::WOODEN_SLAB, "meta" => Planks::DARK_OAK], ["id" => Item::STONE_SLAB, "meta" => StoneSlab::BRICK], ["id" => Item::STONE_SLAB, "meta" => StoneSlab::SANDSTONE], ["id" => Item::RED_SANDSTONE_SLAB], #blamemojang
		["id" => Item::STONE_SLAB, "meta" => StoneSlab::STONE_BRICK], ["id" => Item::STONE_SLAB, "meta" => StoneSlab::QUARTZ], ["id" => Item::STONE_SLAB, "meta" => StoneSlab::NETHER_BRICK], ["id" => Item::QUARTZ_BLOCK], ["id" => Item::QUARTZ_BLOCK, "meta" => Quartz::QUARTZ_PILLAR], ["id" => Item::QUARTZ_BLOCK, "meta" => Quartz::QUARTZ_CHISELED], ["id" => Item::COAL_ORE], ["id" => Item::IRON_ORE], ["id" => Item::GOLD_ORE], ["id" => Item::DIAMOND_ORE], ["id" => Item::LAPIS_ORE], ["id" => Item::REDSTONE_ORE], ["id" => Item::EMERALD_ORE], ["id" => Item::NETHER_QUARTZ_ORE], ["id" => Item::OBSIDIAN], ["id" => Item::ICE], ["id" => Item::PACKED_ICE], ["id" => Item::SNOW_BLOCK], ["id" => Item::END_STONE],], self::CATEGORY_DECORATION => [["id" => Item::COBBLESTONE_WALL], ["id" => Item::COBBLESTONE_WALL, "meta" => StoneWall::MOSSY_WALL], ["id" => Item::LILY_PAD], ["id" => Item::GOLD_BLOCK], ["id" => Item::IRON_BLOCK], ["id" => Item::DIAMOND_BLOCK], ["id" => Item::LAPIS_BLOCK], ["id" => Item::COAL_BLOCK], ["id" => Item::EMERALD_BLOCK], ["id" => Item::REDSTONE_BLOCK], ["id" => Item::SNOW_LAYER], ["id" => Item::GLASS], ["id" => Item::GLOWSTONE], ["id" => Item::VINES], ["id" => Item::LADDER], ["id" => Item::SPONGE], ["id" => Item::GLASS_PANE], ["id" => Item::OAK_DOOR], ["id" => Item::SPRUCE_DOOR], ["id" => Item::BIRCH_DOOR], ["id" => Item::JUNGLE_DOOR], ["id" => Item::ACACIA_DOOR], ["id" => Item::DARK_OAK_DOOR], ["id" => Item::IRON_DOOR], ["id" => Item::WOODEN_TRAPDOOR], ["id" => Item::IRON_TRAPDOOR], ["id" => Item::FENCE, "meta" => Planks::OAK], ["id" => Item::FENCE, "meta" => Planks::SPRUCE], ["id" => Item::FENCE, "meta" => Planks::BIRCH], ["id" => Item::FENCE, "meta" => Planks::JUNGLE], ["id" => Item::FENCE, "meta" => Planks::ACACIA], ["id" => Item::FENCE, "meta" => Planks::DARK_OAK], ["id" => Item::NETHER_BRICK_FENCE], ["id" => Item::OAK_FENCE_GATE], ["id" => Item::SPRUCE_FENCE_GATE], ["id" => Item::BIRCH_FENCE_GATE], ["id" => Item::JUNGLE_FENCE_GATE], ["id" => Item::ACACIA_FENCE_GATE], ["id" => Item::DARK_OAK_FENCE_GATE], ["id" => Item::IRON_BARS], ["id" => Item::BED], ["id" => Item::BOOKSHELF], ["id" => Item::SIGN], ["id" => Item::PAINTING], ["id" => Item::ITEM_FRAME], ["id" => Item::CRAFTING_TABLE], ["id" => Item::CHEST], ["id" => Item::TRAPPED_CHEST], ["id" => Item::FURNACE], ["id" => Item::BREWING_STAND], ["id" => Item::CAULDRON], ["id" => Item::NOTEBLOCK], ["id" => Item::END_PORTAL_FRAME], ["id" => Item::ANVIL], ["id" => Item::ANVIL, "meta" => Anvil::SLIGHTLY_DAMAGED], ["id" => Item::ANVIL, "meta" => Anvil::VERY_DAMAGED], ["id" => Item::DANDELION], ["id" => Item::POPPY, "meta" => Flower::TYPE_POPPY], ["id" => Item::POPPY, "meta" => Flower::TYPE_BLUE_ORCHID], ["id" => Item::POPPY, "meta" => Flower::TYPE_ALLIUM], ["id" => Item::POPPY, "meta" => Flower::TYPE_AZURE_BLUET], ["id" => Item::POPPY, "meta" => Flower::TYPE_RED_TULIP], ["id" => Item::POPPY, "meta" => Flower::TYPE_ORANGE_TULIP], ["id" => Item::POPPY, "meta" => Flower::TYPE_WHITE_TULIP], ["id" => Item::POPPY, "meta" => Flower::TYPE_PINK_TULIP], ["id" => Item::POPPY, "meta" => Flower::TYPE_OXEYE_DAISY], ["id" => Item::DOUBLE_PLANT, "meta" => DoublePlant::SUNFLOWER], ["id" => Item::DOUBLE_PLANT, "meta" => DoublePlant::LILAC], ["id" => Item::DOUBLE_PLANT, "meta" => DoublePlant::DOUBLE_TALLGRASS], ["id" => Item::DOUBLE_PLANT, "meta" => DoublePlant::LARGE_FERN], ["id" => Item::DOUBLE_PLANT, "meta" => DoublePlant::ROSE_BUSH], ["id" => Item::DOUBLE_PLANT, "meta" => DoublePlant::PEONY], ["id" => Item::BROWN_MUSHROOM], ["id" => Item::RED_MUSHROOM], ["id" => Item::BROWN_MUSHROOM_BLOCK, "meta" => 14], ["id" => Item::RED_MUSHROOM_BLOCK, "meta" => 14], ["id" => Item::BROWN_MUSHROOM_BLOCK, "meta" => 0], ["id" => Item::BROWN_MUSHROOM_BLOCK, "meta" => 15], ["id" => Item::CACTUS], ["id" => Item::MELON_BLOCK], ["id" => Item::PUMPKIN], ["id" => Item::JACK_O_LANTERN], ["id" => Item::COBWEB], ["id" => Item::HAY_BALE], ["id" => Item::TALL_GRASS, "meta" => TallGrass::NORMAL], ["id" => Item::TALL_GRASS, "meta" => TallGrass::FERN], ["id" => Item::DEAD_BUSH], ["id" => Item::SAPLING, "meta" => Sapling::OAK], ["id" => Item::SAPLING, "meta" => Sapling::SPRUCE], ["id" => Item::SAPLING, "meta" => Sapling::BIRCH], ["id" => Item::SAPLING, "meta" => Sapling::JUNGLE], ["id" => Item::SAPLING, "meta" => Sapling::ACACIA], ["id" => Item::SAPLING, "meta" => Sapling::DARK_OAK], ["id" => Item::LEAVES, "meta" => Leaves::OAK], ["id" => Item::LEAVES, "meta" => Leaves::SPRUCE], ["id" => Item::LEAVES, "meta" => Leaves::BIRCH], ["id" => Item::LEAVES, "meta" => Leaves::JUNGLE], ["id" => Item::LEAVES2, "meta" => Leaves::ACACIA], #blamemojang
		["id" => Item::LEAVES2, "meta" => Leaves::DARK_OAK], ["id" => Item::CAKE], ["id" => Item::SKULL, "meta" => Skull::SKELETON], ["id" => Item::SKULL, "meta" => Skull::WITHER_SKELETON], ["id" => Item::SKULL, "meta" => Skull::ZOMBIE_HEAD], ["id" => Item::SKULL, "meta" => Skull::STEVE_HEAD], ["id" => Item::SKULL, "meta" => Skull::CREEPER_HEAD], ["id" => Item::FLOWER_POT], ["id" => Item::MONSTER_SPAWNER], ["id" => Item::ENCHANTMENT_TABLE], ["id" => Item::SLIME_BLOCK], ["id" => Item::WOOL, "meta" => 0], //White
	...
	], self::CATEGORY_TOOLS => [["id" => Item::RAIL], ["id" => Item::POWERED_RAIL], ["id" => Item::DETECTOR_RAIL], ["id" => Item::ACTIVATOR_RAIL], ["id" => Item::TORCH], ["id" => Item::BUCKET], ["id" => Item::BUCKET, "meta" => 1], ["id" => Item::BUCKET, "meta" => 8], ["id" => Item::BUCKET, "meta" => 10], ["id" => Item::TNT], ["id" => Item::LEAD], ["id" => Item::NAMETAG], ["id" => Item::REDSTONE_DUST], ["id" => Item::BOW], ["id" => Item::FISHING_ROD], ["id" => Item::FLINT_STEEL], ["id" => Item::SHEARS], ["id" => Item::CLOCK], ["id" => Item::COMPASS], ["id" => Item::MINECART], ["id" => Item::MINECART_WITH_CHEST], ["id" => Item::MINECART_WITH_HOPPER], ["id" => Item::MINECART_WITH_TNT], ["id" => Item::BOAT, "meta" => Planks::OAK], ["id" => Item::BOAT, "meta" => Planks::SPRUCE], ["id" => Item::BOAT, "meta" => Planks::BIRCH], ["id" => Item::BOAT, "meta" => Planks::JUNGLE], ["id" => Item::BOAT, "meta" => Planks::ACACIA], ["id" => Item::BOAT, "meta" => Planks::DARK_OAK], ["id" => Item::SADDLE], ["id" => Item::LEATHER_HORSE_ARMOR], ["id" => Item::IRON_HORSE_ARMOR], ["id" => Item::GOLD_HORSE_ARMOR], ["id" => Item::DIAMOND_HORSE_ARMOR], ["id" => Item::SPAWN_EGG, "meta" => 15], //Villager
